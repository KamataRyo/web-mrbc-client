...
var endpoint = 'http://web-mrbc.wakayamarb.org';
// eslint-disable-next-line no-undef
angular.module('web-mrbc-client', ['ngRoute']).config(['$locationProvider', '$routeProvider', function ($locationProvider, $routeProvider) {
    ...
    return {
        ...
        link: function link(scope, element, attrs) {
            var getCompiledFileName = function getCompiledFileName(filename) {
...
}).controller('tabCtrl', ['$scope', '$location', '$http', '$httpParamSerializer', function ($scope, $location, $http, $httpParamSerializer) {
...
//# sourceMappingURL=web-mrbc-client.js.map
